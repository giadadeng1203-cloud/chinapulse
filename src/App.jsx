...
function AboutPage({ onNav }) {
  return (
    <main style={{ maxWidth:720, margin:"0 auto", padding:"2rem 1.5rem" }}>
      ...
      <p style={{ fontFamily:C.serif, fontSize:"16px", lineHeight:"1.82", color:C.textSub, marginBottom:"1.2rem" }}>Every day, our automated pipeline scans the best Chinese and international sources — including 虎嗅, 36氪, 赢商网, 华丽志, alongside Pandaily, TechNode, Sixth Tone, and SCMP — selects the 10 most important business stories, and publishes original English analysis with a "Why It Matters" for each.</p>
