...
const AUDIENCES = [
  {
    id: "brand", icon: "🏢",
    label: "Brand & Commercial Leaders",
    sublabel: "CMOs · China GMs · Regional VPs",
    color: "#C8102E",
    implication: "Premium mall footfall hitting post-2019 highs and 'situational consumption' driving 2× conversion in offline pop-ups signals it's time to rebalance China media spend away from pure performance digital toward curated in-store experiences — particularly in Jing'an and Sanlitun flagship corridors.",
  },
  {
    id: "investor", icon: "📊",
    label: "Investors & Analysts",
    sublabel: "VCs · PE · Equity Analysts · Family Offices",
    color: "#1B5FA8",
    implication: "February retail beat (+4.2% vs +3.6% consensus) combined with AI-native commerce projected to hit 35% of GMV by 2028 creates a compelling long thesis on domestic consumption proxies — Meituan, CTRIP, and Alibaba's Quanzhantui ad system are the clearest near-term beneficiaries.",
  },
  {
    id: "watcher", icon: "🔭",
    label: "China Watchers",
    sublabel: "Advisors · Consultants · Analysts · Researchers",
    color: "#6B3A8A",
    implication: "The Lululemon vs Alo Yoga brand crisis case is a textbook illustration of China's new trust mechanics: an 8-hour response vs a 5-day response produced an 18-point brand intimacy gap. Any advisory work on China market entry or crisis comms should now include a social media response SLA as a non-negotiable.",
  },
];
